...
let BattlesClient = new function () {
    ...
    this.handleReceiveMessage = function (rawMsg) {
        ...
        switch (msg.c) {
            case 101:
                receiveJoinedTableData(msg.d[0], msg.d[1], msg.d[2], msg.d[3], msg.d[4], msg.d[5], msg.d[6]);
                break;
            case 102:
                receivePlayerJoinedTable(msg.d[0]);
                break;
            case 103:
                receivePlayerLeftTable(msg.d[0]);
                break;
            case 105:
                receivePlayerReady(msg.d[0]);
                break;
            case 211:
                receiveRoundCountdownStart();
                break;
            case 212:
                receiveRoundGuessingPhaseStart();
                break;
            case 213:
                receiveRoundEnd(msg.d[0]);
                break;
            case 221:
                receivePlayerGuess(msg.d[0], msg.d[1].matches);
                break;
            default:
                console.error("Unknown websockets message type.");
        }
    };
